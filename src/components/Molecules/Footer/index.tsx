...
export default function Footer() {
  ...
  function copyFailureNotification() {
  ...
  async function copyText(information: string) {

     try {
      await copy(information, {
        debug: true,
        message: 'Press #{key} to copy',
      });
       copySuccessNotification(information)
     } catch (err) {
      copyFailureNotification()
